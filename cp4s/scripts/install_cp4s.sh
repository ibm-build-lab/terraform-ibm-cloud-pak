...
./cloudctl-linux-amd64 case launch -t 1 --case ibm-cp-security --namespace ${NAMESPACE}  --inventory installProduct --action install --args "--license accept --helm3 $HELM3 --inputDir ./cp4s_cli_install/"
