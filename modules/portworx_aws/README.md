...
**Module Source**: `github.com/ibm-build-lab/terraform-ibm-cloud-pak.git//modules/aws_portworx`
...
```hcl
module "portworx" {
  source                = "github.com/ibm-build-lab/terraform-ibm-cloud-pak.git//modules/aws_portworx"
  region                = var.region
