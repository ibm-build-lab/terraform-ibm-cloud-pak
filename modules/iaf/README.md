...
**Module Source**: `github.com/ibm-build-labs/terraform-ibm-cloud-pak.git//modules/iaf`
...
Use a `module` block assigning `source` to `github.com/ibm-build-labs/terraform-ibm-cloud-pak.git//modules/iaf`. Then set the [input variables](#input-variables) required to install Automation Foundation. Refer [here](../../examples/iaf) for an example:

```hcl
module "iaf" {
  source = "github.com/ibm-build-labs/terraform-ibm-cloud-pak.git//modules/iaf"
  enable = true
...
For an example of how to put all this together, refer to our [IBM Automation Foundation Terraform script](https://github.com/ibm-build-labs/cloud-pak-sandboxes/tree/master/terraform/iaf).
