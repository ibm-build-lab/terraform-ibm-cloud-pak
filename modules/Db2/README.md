...
Follow this link to execute this DB2 module: [Install IBM Cloud Pak DB2 Terraform Example](https://github.com/ibm-build-lab/terraform-ibm-cloud-pak/tree/main/examples/Db2)
