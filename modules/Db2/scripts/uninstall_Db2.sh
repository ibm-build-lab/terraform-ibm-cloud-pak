...
for resource in subscription deployments deploymentconfigs configmaps OperatorGroup statefulset EventStreams csv scc jobs pods secrets pv pvc services roles rolebindings namespaces ;
do
