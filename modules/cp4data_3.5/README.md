...
**Module Source**: `github.com/ibm-build-labs/terraform-ibm-cloud-pak.git//modules/cp4data_3.5`
...
Use a `module` block assigning `source` to `github.com/ibm-build-labs/terraform-ibm-cloud-pak.git//cp4data_3.5`. Then set the [input variables](#input-variables) required to install the Cloud Pak for Data.
