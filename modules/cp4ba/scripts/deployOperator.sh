...
function show_help {
    ...
    echo "      For example: cp.icr.io/cp/icp4ba-operator:20.0.3 or registry_url/icp4ba-operator:version"
...
#         oc adm policy add-scc-to-user privileged -z ibm-cp4ba-operator -n ${NAMESPACE}
...
if [[ $LICENSE_ACCEPTED == "accept" ]]; then
    ...
    # kubectl apply -f ${CUR_DIR}/../descriptors/ibm_cp4ba_crd.yaml --validate=false
