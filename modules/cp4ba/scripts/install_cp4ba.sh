...
EOF
  ...
  CREATE_PVC_RESULT=$(kubectl apply -f -<<EOF "${OPERATOR_SHARED_PV_CONTENT}" --validate=false
EOF
)
  ...
  CREATE_PVC_RESULT=$(kubectl apply -f -<<EOF "${SHARED_LOG_PV_CONTENT}" --validate=false
EOF
)
  ...
  CREATE_PVC_RESULT=$(kubectl apply -f -<<EOF "${OPERATOR_SHARED_PVC_CONTENT}" --validate=false
EOF
)
  ...
  CREATE_PVC_RESULT=$(kubectl apply -f -<<EOF "${SHARED_LOG_PVC_CONTENT}" --validate=false
EOF
)
