...
These modules are used by Terraform scripts in [this](https://github.com/ibm-build-lab/cloud-pak-sandboxes/tree/master/terraform) directory.
...
| [portworx](https://github.com/ibm-build-lab/terraform-ibm-cloud-pak/tree/main/modules/portworx)  | Installs Portworx on an existing OpenShift 4.6 VPC cluster                          | `github.com/ibm-build-lab/terraform-ibm-cloud-pak.git//modules/portworx`  |
| [portworx_aws](https://github.com/ibm-build-lab/terraform-ibm-cloud-pak/tree/main/modules/portworx_aws)  | Installs Portworx on an existing AWS ROSA cluster                          | `github.com/ibm-build-lab/terraform-ibm-cloud-pak.git//modules/portworx_aws`  |
| [odf](https://github.com/ibm-build-lab/terraform-ibm-cloud-pak/tree/main/modules/odf)  | Installs OpenShift Data Platform on an existing OpenShift 4.7 cluster                          | `github.com/ibm-build-lab/terraform-ibm-cloud-pak.git//modules/odf`  |
| [iaf](https://github.com/ibm-build-lab/terraform-ibm-cloud-pak/tree/main/modules/iaf)  | Installs the IBM Automation Foundation on an existing OpenShift cluster                          | `github.com/ibm-build-lab/terraform-ibm-cloud-pak.git//modules/iaf`  |
...
| [cp4app](https://github.com/ibm-build-lab/terraform-ibm-cloud-pak/tree/main/modules/cp4app)  | Installs the Cloud Pak for Applications on an existing OpenShift cluster                        | `github.com/ibm-build-lab/terraform-ibm-cloud-pak.git//modules/cp4app`  |
| [cp4auto](https://github.com/ibm-build-lab/terraform-ibm-cloud-pak/tree/main/modules/cp4auto)  | Installs the Cloud Pak for Automation on an existing OpenShift cluster                        | `github.com/ibm-build-lab/terraform-ibm-cloud-pak.git//modules/cp4app`  |
...
| [cp4data](https://github.com/ibm-build-lab/terraform-ibm-cloud-pak/tree/main/modules/cp4data) | Installs the Cloud Pak for Data 3.5 on an existing OpenShift cluster                                 | `github.com/ibm-build-lab/terraform-ibm-cloud-pak.git//modules/cp4data` |
| [cp4data_4.0](https://github.com/ibm-build-lab/terraform-ibm-cloud-pak/tree/main/modules/cp4data_4.0) | Installs the Cloud Pak for Data 4.0.5 on an existing OpenShift cluster                                 | `github.com/ibm-build-lab/terraform-ibm-cloud-pak.git//modules/cp4data_4.0` |
| [cp4data_3.5_aws](https://github.com/ibm-build-lab/terraform-ibm-cloud-pak/tree/main/modules/cp4data_3.5_aws) | Installs the Cloud Pak for Data 3.5 on an existing AWS ROSA cluster                                 | `github.com/ibm-build-lab/terraform-ibm-cloud-pak.git//modules/cp4data_3.5_aws` |
...
| [cp4i_aws](https://github.com/ibm-build-lab/terraform-ibm-cloud-pak/tree/main/modules/cp4i_aws)  | Installs the Cloud Pak for Integration on an existing AWS ROSA cluster                          | `github.com/ibm-build-lab/terraform-ibm-cloud-pak.git//modules/cp4i_aws`  |
| [cp4mcm](https://github.com/ibm-build-lab/terraform-ibm-cloud-pak/tree/main//modules/cp4mcm)  | Installs the Cloud Pak for MultiCloud Management on an existing OpenShift cluster                | `github.com/ibm-build-lab/terraform-ibm-cloud-pak.git//modules/cp4mcm`  |
| [cp4mcm_aws](https://github.com/ibm-build-lab/terraform-ibm-cloud-pak/tree/main//modules/cp4mcm_aws)  | Installs the Cloud Pak for MultiCloud Management on an existing AWS ROSA cluster                | `github.com/ibm-build-lab/terraform-ibm-cloud-pak.git//modules/cp4mcm_aws`  |
