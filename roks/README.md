...
| `project_name`         | The project name is used to name the cluster with the environment name, like this: `{project_name}-{environment}-cluster` It's also used to label the cluster and other resources                                                                                                                                                                                                                                         |                  | Yes      |
